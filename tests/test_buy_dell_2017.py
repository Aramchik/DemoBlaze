...
def test_buy_dell_2017(browser):
    m = MainPage(browser)
    m.open()
    m.click_laptops()
    print("Click Laptops")
    m.click_dell_2017()
    print("Click Dell 2017 15.6 inch")

    dell2017 = Dell_2017(browser)
    dell2017.click_dell_2017()
    print("Click add to cart")

    m.click_cart()
    print('Click cart')

    m.assert_values(word=dell2017.get_dell_2017_name(), result="2017 Dell 15.6 Inch")
    print('Name good')
